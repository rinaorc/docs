...
➺ Une fois les bases acquises, entrons dans le vif du sujet. En minant, vous allez obtenir des armures et des gemmes. Ce sont des objets permettant d'augmenter vos statistiques (que vous pouvez voir grâce à la commande /stat ou encore dans le tab du jeu). Ils peuvent vous donner une ou plusieurs statistiques (dépendant de sa rareté) avec un certain bonus. Elles peuvent augmenter votre statistique de RinaCoins, de Tokens, d'XP de pioche, de critique enchant ou encore de mana. Pour plus de détails sur les objets, cliquez ici : [objets](redirection).
